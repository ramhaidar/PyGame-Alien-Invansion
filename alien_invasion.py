...
class AlienInvasion:
    """Main game class that manages game assets and behavior."""
    ...
    def _handle_game_exit(self):
        """Handle game exit procedures."""
        # Save high scores or game state here if needed
        sys.exit()
